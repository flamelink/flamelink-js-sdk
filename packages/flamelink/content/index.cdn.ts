...
import getApiForRTDB from '@flamelink/sdk-content/dist/rtdb'
import getApiForCF from '@flamelink/sdk-content/dist/cf'

const content: App.SetupModule = (context: App.Context) => {
